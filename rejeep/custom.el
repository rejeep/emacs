...
(custom-set-variables
 ...
 '(openwith-associations (quote (("\\.odt|\\.doc?\\'" "oowriter" (file)) ("\\.pdf\\'" "epdfview" (file)) ("\\.mp3\\'" "mocp" (file)) ("\\.\\(?:mpe?g\\|avi\\|wmv\\|mov\\|ogg\\)\\'" "mplayer" ("-idx" file)) ("\\.\\(?:jp?g\\|png\\)\\'" "gwenview" (file)) ("\\.xls" "oocalc" (file)))))
 '(truncate-lines t))
